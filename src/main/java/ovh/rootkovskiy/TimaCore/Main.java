...
import ovh.rootkovskiy.TimaCore.Utils.CfgMaster;
...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        saveDefaultConfig();
        cfgspawn = new CfgMaster("spawn.yml");
        cfgtranslation = new CfgMaster("translation.yml");
        cfghomes = new CfgMaster("homes.yml");
        cfgwarps = new CfgMaster("warps.yml");

        CommandsRegister.commands();
        EventsRegister.loadEvents();
